...
function trolledFavicon() {
  var favicon=new Favico();
  var image=document.getElementById('trollface');
  favicon.image(image);
}
...
$(function() {
  ...
  let modalTemplate = `
  <a href="#" class="modal--close btn btn-static-secondary hidden-xs" onclick="closeModal(this)"><span class="icon icon-cancel"></span></a>
  <a href="#" class="modal--close btn btn-static-secondary visible-xs" onclick="closeModal(this)">close modal</a>
